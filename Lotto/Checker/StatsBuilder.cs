...
namespace Lotto.Checker
{
    public static class StatsBuilder
    {
        public static string BuildMatchedStatistics(IEnumerable<LottoSelection> results)
        {
            ...
            var padLeftLength = $"{results.Count()}".Length;
            ...
            sb.AppendLine($"Matched 0 balls, 0 powerballs: {matched0Balls0PowerBalls}");
            sb.AppendLine($"Matched 0 balls, 1 powerballs: {matched0Balls1PowerBalls}");
            sb.AppendLine($"Matched 0 balls, 2 powerballs: {matched0Balls2PowerBalls}");

            sb.AppendLine($"Matched 1 balls, 0 powerballs: {matched1Balls0PowerBalls}");
            sb.AppendLine($"Matched 1 balls, 1 powerballs: {matched1Balls1PowerBalls}");
            sb.AppendLine($"Matched 1 balls, 2 powerballs: {matched1Balls2PowerBalls}");

            sb.AppendLine($"Matched 2 balls, 0 powerballs: {matched2Balls0PowerBalls}");
            sb.AppendLine($"Matched 2 balls, 1 powerballs: {matched2Balls1PowerBalls}");
            sb.AppendLine($"Matched 2 balls, 2 powerballs: {matched2Balls2PowerBalls}");

            sb.AppendLine($"Matched 3 balls, 0 powerballs: {matched3Balls0PowerBalls}");
            sb.AppendLine($"Matched 3 balls, 1 powerballs: {matched3Balls1PowerBalls}");
            sb.AppendLine($"Matched 3 balls, 2 powerballs: {matched3Balls2PowerBalls}");

            sb.AppendLine($"Matched 4 balls, 0 powerballs: {matched4Balls0PowerBalls}");
            sb.AppendLine($"Matched 4 balls, 1 powerballs: {matched4Balls1PowerBalls}");
            sb.AppendLine($"Matched 4 balls, 2 powerballs: {matched4Balls2PowerBalls}");

            sb.AppendLine($"Matched 5 balls, 0 powerballs: {matched5Balls0PowerBalls}");
            sb.AppendLine($"Matched 5 balls, 1 powerballs: {matched5Balls1PowerBalls}");
            sb.AppendLine($"Matched 5 balls, 2 powerballs: {matched5Balls2PowerBalls}");
